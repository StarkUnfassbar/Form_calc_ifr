            ...
            formBlock.querySelectorAll(".block_inputs:not(.radio)").forEach(blockInputs2 => {
                if(blockInputs2 != blockInputs1 && blockInputs2 != blockInputsLast){
                    ...
                    if ((startDate1 <= endDate2 && startDate1 >= startDate2) || (startDate2 <= endDate1 && startDate2 >= startDate1)){
                        if(!blockInputs1.querySelector(".error_text")){
                            blockInputs1.classList.add("_error");
                            blockInputs1.insertAdjacentHTML("beforeend", errorHtml);
                        }
    
                        if(!blockInputs2.querySelector(".error_text")){
                            blockInputs2.classList.add("_error");
                            blockInputs2.insertAdjacentHTML("beforeend", errorHtml);
                        }
